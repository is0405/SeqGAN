...
def dataset_for_generator(data_file, batch_size, sec_length):
    token_stream = []
...
def dataset_for_discriminator(positive_file, negative_file, batch_size, sec_length):
    examples = []
    labels = []
